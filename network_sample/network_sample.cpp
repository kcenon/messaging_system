...
int main()
{
	...
	std::shared_ptr<tcp_server> server = std::make_shared<tcp_server>(L"server", L"any string can be used for it");
	...
	std::shared_ptr<tcp_client> client = std::make_shared<tcp_client>(L"client", L"any string can be used for it");
