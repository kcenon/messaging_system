...
namespace container
{
	...
	short_value::short_value(const std::wstring& name, const short& value)
		: value(name, (const char*)&value, sizeof(short), value_types::short_value)
	{
	}
	...
	std::wstring short_value::to_string(const bool&) const
	{
