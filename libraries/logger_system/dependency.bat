...
REM Logger System Dependency Installation Script for Windows

REM Display banner
echo ============================================
echo    Logger System Dependency Installer
echo ============================================
...
if not exist vcpkg.json (
    ...
    (
        echo {
        echo   "name": "logger-system",
        echo   "version": "1.0.0",
        echo   "description": "High-performance asynchronous logging system",
        echo   "dependencies": [
        echo     "fmt",
        echo     "gtest"
        echo   ]
...
echo.
echo Next steps:
echo   1. Run 'build.bat' to build the Logger System
