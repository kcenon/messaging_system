...
# Logger System Dependency Installation Script
...
# Display banner
echo -e "${BOLD}${BLUE}============================================${NC}"
echo -e "${BOLD}${BLUE}   Logger System Dependency Installer      ${NC}"
echo -e "${BOLD}${BLUE}============================================${NC}"
...
# Install vcpkg packages for Logger System
print_status "Installing vcpkg packages for Logger System..."
    ...
    cat > vcpkg.json << 'EOF'
{
  "name": "logger-system",
  "version": "1.0.0",
  "description": "High-performance asynchronous logging system",
  "dependencies": [
    "fmt",
    "gtest"
  ]
...
echo -e "  ${CYAN}C++ Libraries:${NC} fmt, gtest"

print_status "Next steps:"
echo "  1. Run './build.sh' to build the Logger System"
