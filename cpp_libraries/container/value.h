...
namespace container
{
	...
	public:
		virtual shared_ptr<value> add(const value& item, const bool& update_count = true) { throw exception("cannot support to add value object on this object"); }
		virtual shared_ptr<value> add(shared_ptr<value> item, const bool& update_count = true) { throw exception("cannot support to add value object on this object"); }
		virtual void add(const vector<value>& target_values, const bool& update_count = true) { throw exception("cannot support to add value objects on this object"); }
		virtual void add(const vector<shared_ptr<value>>& target_values, const bool& update_count = true) { throw exception("cannot support to add value objects on this object"); }
		virtual void remove(const wstring& target_name, const bool& update_count = true) { throw exception("cannot support to remove value objects on this object"); }
		virtual void remove(shared_ptr<value> item, const bool& update_count = true) { throw exception("cannot support to remove value object on this object"); }
		virtual void remove_all(void) { throw exception("cannot support to remove value object on this object"); }
