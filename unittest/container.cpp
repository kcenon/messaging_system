...
TEST(container, test)
{
    ...
    EXPECT_STREQ(converter::to_string(data.serialize()).c_str(), converter::to_string(data2.serialize()).c_str());
    ...
    EXPECT_STRNE(converter::to_string(data.serialize()).c_str(), converter::to_string(data2.serialize()).c_str());
